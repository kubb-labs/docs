...
Run the `humanizer` skill over any user-facing markdown you write or edit and fix the tells it
surfaces in that same pass. Do this by default as part of writing the file, not only when asked.
