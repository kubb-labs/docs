...
- Generate a typed [Axios](https://kubb.dev/plugins/plugin-axios) or [Fetch](https://kubb.dev/plugins/plugin-fetch) client with status-keyed results, auth, validation, server-sent events, interceptors, and a swappable transport.
