...
The [plugin](/docs/5.x/guide/concepts/plugins) architecture was overhauled. Generation runs faster, and the CLI shows a progress bar so you can see what is running.
