...
const highlights = [
  ...
  { value: 288, label: 'OpenAI operations in 6.2s' },
]
</script>
...
The [OpenAI spec](https://github.com/openai/openai-openapi) is 288 operations across 2.7 MB of YAML. Generating types, an Axios client, Zod schemas, and Faker mocks from it took 30.7 seconds in v4. v5 does the same work in 6.2 seconds.
