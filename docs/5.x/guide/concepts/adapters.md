...
`createAdapter`, the `Adapter` interface, streaming, the OpenAPI adapter options, and a worked custom-adapter example live in the [Adapters API reference](/docs/5.x/api/adapters).
