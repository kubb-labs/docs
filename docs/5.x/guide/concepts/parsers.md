...
`defineParser`, the `Parser` interface, the built-in `@kubb/parser-ts`, and a worked custom-parser example live in the [Parsers API reference](/docs/5.x/api/parsers).
