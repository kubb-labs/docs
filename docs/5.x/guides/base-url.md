...
When [defining your own client](/docs/5.x/guides/fetch), set a baseURL that applies to every HTTP call.
...
Reuse the server URL from your Swagger/OpenAPI spec file by defining [which index](/adapters/adapter-oas) to use.
