...
> [!IMPORTANT]
> The generated requests need **Cypress v13 or higher**. They are typed against the ambient `Cypress.Chainable` and `Cypress.RequestOptions` globals that the `cypress` package declares.
