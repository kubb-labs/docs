...
> [!IMPORTANT]
> The generated schemas need **Zod v4 or higher**. They use v4-only APIs such as `z.ipv4()` and `.meta()`, and read from `zod/mini` when you point `importPath` at the tree-shakeable bundle.
